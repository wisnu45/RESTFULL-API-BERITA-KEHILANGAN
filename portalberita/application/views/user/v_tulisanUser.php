...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; PENCARIAN BARANG HILANG </a>.</strong> All rights reserved.
  </footer>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">       
                     ...
                     <input type="hidden" value="<?php echo $tulisan_gambar;?>" name="gambar">
                            <p>Ajukan Permintaan Anda Melalui Pengiriman Pesan untuk menghapus Posting | <b><?php echo $tulisan_judul;?></b> ?</p>
